		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title">Register User: Its Free(0frs FCFA)</h1>
				</header>
				...
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							{{ Form::open(array('url' => 'register_user', 'method' => 'post')) }}
								<div class="top-margin">
									<label>Company Name <span class="text-danger">*</span></label>
									{{ Form::text('company', Input::old('company'), array('placeholder'=>'Your Company Name',
									 'class' => 'form-control')) }}
								</div>
								...
								<div class="top-margin">
									...
									{{ Form::number('phone', Input::old('phone'), array('placeholder'=>'e.g. (+237) 6x-xx-xx-xxx',
									 'class' => 'form-control')) }}
								</div>
